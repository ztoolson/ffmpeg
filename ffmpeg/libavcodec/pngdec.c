...
/* Mask to determine which pixels are valid in a pass */ static const uint8_t png_pass_mask[NB_PASSES] = { 0x01, 0x01, 0x11, 0x11, 0x55, 0x55, 0xff, };
...
{ 
    /* Section added for Checkpoint 1 of ffmpeg assignment for cs3505
     * at the University of Utah
     */

    /* Static member variable to alert us if item is printed */
    static int is_printed_3505 = 0;

    /* Added print statement when png file is loaded */

    if(is_printed_3505 == 0)
    {
      printf("*** CS 3505:  Executing in METHOD:png_dec_init FILE:pngdec.c ***\n");
      printf("*** CS 3505:  Altered by Michael Call and Zach Toolson ***\n");

      is_printed_3505 = 1;
    }

    /* End of Checkpoint 1 addition */
