...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/home/toolson/ffmpeg --disable-yasm
...
CC_IDENT=gcc 4.4.7 (GCC) 20120313 (Red Hat 4.4.7-3)
ARCH=x86
CC=gcc
CXX=g++
AS=gcc
...
CFLAGS=   -std=c99 -fomit-frame-pointer -pthread -D_GNU_SOURCE=1 -D_REENTRANT -I/usr/include/SDL -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla
...
EXTRALIBS=-ldl -lXv -lX11 -lXext -lX11 -lasound -lSDL -lpthread -lm -lz -pthread -lrt 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
...
libavcodec_VERSION=55.52.101
libavcodec_VERSION_MAJOR=55
libavcodec_VERSION_MINOR=52
libavdevice_VERSION=55.9.100
